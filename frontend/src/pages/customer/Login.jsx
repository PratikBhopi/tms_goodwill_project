    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md bg-white rounded-xl shadow-md p-8">
        ...
        <div className="mt-5 flex flex-col items-center gap-2 text-sm text-gray-600">
          <Link to="/customer/forgot-password" className="text-blue-600 hover:underline">Forgot password?</Link>
          <span>
            Don&apos;t have an account?{' '}
            <Link to="/customer/register" className="text-blue-600 hover:underline font-medium">Register</Link>
          </span>
        </div>
      </div>
    </div>
